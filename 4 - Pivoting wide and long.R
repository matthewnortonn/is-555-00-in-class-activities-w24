...
# ri is religious income data
#each cell is showing how many households make that bracket of income in that religion
ri
#going from wide data to long data
ri_long <- ri %>% 
  pivot_longer(
    cols = !religion, #grab all columns that aren't religion
...
#practicing switching data from long to wide, here are several ways to do it
#this is just exploring options, not exactly a right or wrong way to go about it
